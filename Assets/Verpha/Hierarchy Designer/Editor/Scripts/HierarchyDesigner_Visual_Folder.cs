...
namespace Verpha.HierarchyDesigner
{
    ...
    public class HierarchyDesigner_Visual_Folder
    {
        ...
        private static readonly (Color folderColor, HierarchyDesigner_Info_Folder.FolderImageType folderImageType) defaultFolderInfo = (Color.white, HierarchyDesigner_Info_Folder.FolderImageType.Default);
